                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ url('/insight') }}">Insight</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header" >
                        <h3 class="card-title">
                            <button type="button" class="btn btn-block bg-gradient-primary add">Add Insight</button>
                        </h3>
                    </div>
                    <!-- /.card-header -->
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Insight Edit</h5>
    ...
    @push('js')
        <script>
            ...
            $(document).on('click', '.news', function() {
                startLoader();
                let in_id = $(this).attr('id').split('_')[1];
                $.ajax({
                    url: '{{ route('insight') }}',
                    method: 'get',
                    data: {
            ...
            $(document).on('click', '.fa-window-close', function() {
                ...
                let div_add = '<div class="col-md-1"><div class="form-group"><i class="fa fa-plus-square"></i></div></div>';
                $('.quiz_rem').children().last().append(div_add);
            });


            $(document).on('click', '.fa-plus-square', function() {
                let div = $(this).parent().parent().parent().clone();
                div.find('input').val('');
                $('.quiz_rem').append(div);
                $('.fa-plus-square').each(function() {
                    $(this).parent().parent().remove();
